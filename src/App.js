          ...
          <div className="Right-Section">
            <div className="GitHub-issues-History-element">
              ...
              <div className="Github-tab-box">
                <div className="Github-tab yellow">
                  ISSUES
                  <FontAwesomeIcon icon="caret-up" className="active" />
                </div>
            ...
            <div className="anuncio-element">
              <div className="anuncio-box content-box">
                <div className="anuncio-img-box">
                  <img className="anuncio-img" src="./img/ads-img.jpg" alt="" />
                  <p className="anuncio-title pink">Anuncios via TA</p>
                </div>
                <div className="anuncio-content gray">
